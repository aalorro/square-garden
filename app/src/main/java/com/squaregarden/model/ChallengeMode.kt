...
enum class ChallengeType(val id: Int, val title: String, val description: String, val starMultiplier: Int = 1, val masterModeOnly: Boolean = false) {
    ...
    FROZEN_WAVE(-5, "Frozen Wave", "A cold front sweeps in! Every 2 moves, a tile freezes solid.", starMultiplier = 2, masterModeOnly = true),
    ROTATION(-6, "Rotation Garden", "Every 3 moves the board rotates 90\u00B0. Stay oriented!", starMultiplier = 3, masterModeOnly = true),
    MIRROR(-7, "Mirror Garden", "Every swap is mirrored across the board center.", starMultiplier = 3, masterModeOnly = true),
    DECAY(-8, "Decay Garden", "Completed goals expire after 5 moves. Be quick!", starMultiplier = 3, masterModeOnly = true);
