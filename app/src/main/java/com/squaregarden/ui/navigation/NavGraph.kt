package com.squaregarden.ui.navigation
...
import com.squaregarden.ui.screens.*

@Composable
fun SquareGardenNavGraph(navController: NavHostController) {
    NavHost(navController = navController, startDestination = Screen.Splash.route) {
        ...
        composable(Screen.MasterMode.route) {
            MasterModeScreen(navController = navController)
        }
    }
}
